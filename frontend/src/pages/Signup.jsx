...
import registerphoto from '../assets/images/inicial/HomeBg.svg'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="hidden lg:block rounded-lg mr-[80px] mt-[80px]">
          <figure className="rounded-l-lg">
            <img src={registerphoto} alt="" className="w-full rounded-l-lg"/>
          </figure>
        </div>
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <div className='relative w-[160px] h-[50px]'>
            ...
            <label htmlFor="customFile" className=' absolute top-0 left-0 flex h-full w-[100px]
